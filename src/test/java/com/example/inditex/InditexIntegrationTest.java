...
public class InditexIntegrationTest {
    ...
    @Nested
    class ConsultarPecio {
        @Test
        @DisplayName("14-06-2020T10:00 -> tarifa 1")
        void prueba1() {
        ...
        @Test
        @DisplayName("14-06-2020T16:00 -> tarifa 2")
        void prueba2() {
            final PriceResponse priceResponse = restClient.get()
                    .uri("/inditex/prices?brandId={brandId}&productId={productId}&applicationDate={applicationDate}",
        ...
        @Test
        @DisplayName("14-06-2020T21:00 -> tarifa 1")
        void prueba3() {
            final PriceResponse priceResponse = restClient.get()
                    .uri("/inditex/prices?brandId={brandId}&productId={productId}&applicationDate={applicationDate}",
        ...
        @Test
        @DisplayName("15-06-2020T10:00 -> tarifa 3")
        void prueba4() {
            final PriceResponse priceResponse = restClient.get()
                    .uri("/inditex/prices?brandId={brandId}&productId={productId}&applicationDate={applicationDate}",
        ...
        @Test
        @DisplayName("16-06-2020T21:00 -> tarifa 4")
        void prueba5() {
            final PriceResponse priceResponse = restClient.get()
                    .uri("/inditex/prices?brandId={brandId}&productId={productId}&applicationDate={applicationDate}",
